...
namespace eval ::optrace {
  variable script "/home/mr-robot/Documents/arch/module01/mips-cpu/RTL/CPUs/Single Cycle with Interrupts/sccompintFPGA.runs/impl_1/mfp_nexys4_ddr.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet {{/home/mr-robot/Documents/arch/module01/mips-cpu/RTL/CPUs/Single Cycle with Interrupts/sccompintFPGA.runs/synth_1/mfp_nexys4_ddr.dcp}}
...
OPTRACE "Write Bitstream: pre hook" START { }
  set src_rc [catch { 
    puts "source /home/mr-robot/Documents/arch/module01/mips-cpu/RTL/Common/oledrgbpins.tcl"
  ...
  if {$src_rc} { 
    ...
    if { $tool_flow eq {SDx} } { 
      ...
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script /home/mr-robot/Documents/arch/module01/mips-cpu/RTL/Common/oledrgbpins.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script /home/mr-robot/Documents/arch/module01/mips-cpu/RTL/Common/oledrgbpins.tcl failed"
    }
    return -code error
  }
