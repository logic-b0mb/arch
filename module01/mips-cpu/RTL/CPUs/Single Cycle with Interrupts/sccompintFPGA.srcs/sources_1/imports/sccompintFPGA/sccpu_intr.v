...
************************************************/
module sccpu_intr (clk,clrn,halt,inst,mem,pc,wmem,alu,data,intr,inta);
    input  [31:0] inst;                           // inst from inst memory
    input  [31:0] mem;                            // data from data memory
    input   halt;                                 // Halt the PC for JTAG Interface
    ...
    cla32 pcplus4 (pc, halt?32'b0:32'h4,1'b0,p4);             // pc + 4
